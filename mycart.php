...
<body class="body">
    ...
    <section>
        ...
        <div class="mycart-nav-bar">
            <div onclick="window.location='mycart.php'" style="border-bottom: 4px solid rgb(57, 128, 235);" class="mycart-nav-bar-item">
                <span>To Pay</span>
            </div>

            <div onclick="window.location='to_ship.php'" class="mycart-nav-bar-item">
                <span>To Ship</span>
            </div>
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        echo "<div id='paynow-btn' onclick=\"window.location='mycart_paynow.php?cartID=".$row['cart_id']."'\">Pay Now</div>";
                                        echo "<div style='margin-right: 0.5rem;' onclick=\"window.location='mycart_delete.php?cartID=".$row['cart_id']."'\" id='paynow-btn'>Delete Item</div>";
                                        echo "<div style='margin-right: 0.5rem;' onclick=\"window.location='product_buy_information.php?productID=".$productID."'\" id='paynow-btn'>View Item</div>";
                                    echo "</div>";
                                echo "</div>";
