...
<body class="body">
    ...
    <section>
        ...
        <div class="mycart-nav-bar">
            ...
            <div style="border-bottom: 4px solid rgb(57, 128, 235);" onclick="window.location='completed.php'" class="mycart-nav-bar-item">
                <span>Completed</span>
            </div>
        </div>
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        ...
                                        echo "<div id='paynow-btn' onclick=\"window.location='product_buy_information.php?productID=".$row_productInformation['product_id']."'\">Buy Again</div>";
                                    echo "</div>";
                                echo "</div>";
